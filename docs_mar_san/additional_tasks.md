- Convert all the code of OSMNX to a new version with OSMR, more useful for a efficiency development
    + Change logic like cut bounding box, because with OSMR is not necessary
    + 
